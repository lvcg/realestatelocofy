        ...
        <form className="self-stretch flex flex-col items-center justify-start gap-[17px]">
          ...
          <div className="flex flex-row items-start justify-start gap-[10px]">
            <button
              ...
              autoFocus
            >
              <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded"> Rent </button> <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded"> Sale </button>
          </div>
          {/* Navigation */}
