        ...
        <form className="self-stretch flex flex-col items-center justify-start gap-[17px]">
          ...
          <div className="flex flex-row items-start justify-start gap-[10px]">
            <button
              ...
              autoFocus
            >
              <div class="container"> <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded"> Rent </button> 
              <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded"> Sale </button>
              </div>
          ...
          <div className="self-stretch flex flex-row flex-wrap items-start justify-center">
            ...
            <nav className="m-0 flex-1 rounded-lg bg-gray-white flex flex-row py-8 px-[62px] box-border items-center justify-between max-w-[1400px] md:w-[300px] md:flex-col md:gap-[20px] md:items-start md:justify-start md:ml-[auto] md:mr-[auto]">
              ...
              <div className="w-[137px] flex flex-col items-start justify-start gap-[16px]">
                <div className="relative text-base leading-[24px] font-semibold font-body-regular-600 text-primary-700 text-center">
                  Locations
                </div>
                <AntDropdown
                  overlay={
...
<div className="w-[177px] flex flex-col items-start justify-start gap-y-4">
  <div className="relative text-base leading-6 font-semibold font-body-regular-600 text-primary-700 text-left flex items-end w-[150px]">
    Property Type
  </div>
  <AntDropdown
...
{/* Rent Range dropdown */}
<div className="w-[155px] flex flex-col items-start justify-start gap-y-4">
  <div className="relative text-base leading-6 font-semibold font-body-regular-600 text-primary-700 text-left flex items-end w-[150px]">
    Rent Range
  </div>
  <AntDropdown
